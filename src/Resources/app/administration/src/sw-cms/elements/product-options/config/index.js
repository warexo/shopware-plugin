import template from './sw-cms-el-config-product-options.html.twig';
import './sw-cms-el-config-product-options.scss';

const { Component, Mixin } = Shopware;
const { Criteria } = Shopware.Data;

Component.register('sw-cms-el-config-product-options', {
    template,
